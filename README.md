...
The LLM handles semantic clue solving, while Python enforces structural crossword constraints.
...
Correct solutions are stored separately from puzzle inputs to avoid leaking answers into inference.
